...
![3](xju-ESP32 1.0.image/3.png)

### 降压

![4](xju-ESP32 1.0.image/4.png)

![5](xju-ESP32 1.0.image/5.png)
...
![6](xju-ESP32 1.0.image/6.png)

### 电源输出

24V用于驱动电机，5V和3.3V可给其他外设供电

![7](xju-ESP32 1.0.image/7.png)

### USB下载

按住BOOT按键然后插入TypeC插口然后松开按键即可进入程序下载模式

![8](xju-ESP32 1.0.image/8.png)

### CAN

ESP32内部自带一个CAN，所以只外接一个CAN。ESP32的CAN叫**TWAI**

![17](xju-ESP32 1.0.image/17.png)
...
![17](xju-ESP32 1.0.image/17-1746259984996-8.png)

### 8路PWM输出

![17](xju-ESP32 1.0.image/17-1746259989673-10.png)

### LED

![11](xju-ESP32 1.0.image/11.png)

### 蜂鸣器

![11](xju-ESP32 1.0.image/11-1746259998537-13.png)

### 按键

BOOT为下载按键，EN为RESET按键

![11](xju-ESP32 1.0.image/11-1746260004113-15.png)

## 二、PCB

PCB的大小的打孔位置和大疆开发板A板相同，8.5cm x 5.8cm

![14](xju-ESP32 1.0.image/14.png)

![15](xju-ESP32 1.0.image/15.png)


## 三、引脚分配（程序请看）

![16](xju-ESP32 1.0.image/16.png)